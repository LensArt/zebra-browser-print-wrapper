...
var ZebraBrowserPrintWrapper = /** @class */ (function () {
    function ZebraBrowserPrintWrapper(apiUrlOverride) {
        if (apiUrlOverride === void 0) { apiUrlOverride = null; }
        var _this = this;
        this.device = {};
        this.apiUrl = constants_1.API_URL;
        this.setApiUrl = function (apiUrl) {
            _this.apiUrl = apiUrl.slice(-1) != "/" ? apiUrl + "/" : apiUrl;
        };
        ...
        this.getDefaultPrinter = function () { return __awaiter(_this, void 0, void 0, function () {
            var config, endpoint, res, data, deviceRaw, name, deviceType, connection, uid, provider, manufacturer, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = {
