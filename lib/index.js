...
System.register("index", [], function (exports_2, context_2) {
    ...
    return {
        setters: [],
        execute: function () {
            ZebraBrowserPrintWrapper = /** @class */ (function () {
                function ZebraBrowserPrintWrapper(api_url) {
                    var _this = this;
                    this.device = {};
                    this.API_URL = "";
                    this.setApiUrl = function (api_url) {
                        _this.API_URL = api_url;
                        if (_this.API_URL.slice(-1) != "/") {
                            _this.API_URL += "/";
                        }
                    };
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    endpoint = this.API_URL + 'available';
                                    _a.label = 1;
                                case 1:
                                    _a.trys.push([1, 4, , 5]);
            ...
            exports_2("default", ZebraBrowserPrintWrapper);
        }
    };
});
